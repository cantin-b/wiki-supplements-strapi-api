...
export interface ApiSupplementSupplement extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    affiliate_info: Schema.Attribute.Component<'shared.affiliate-info', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    available_status: Schema.Attribute.Enumeration<
      ['AVAILABLE', 'HARD_TO_FIND', 'BANNED']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
